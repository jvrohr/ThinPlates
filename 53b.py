...
plt.savefig(figDirectory + '\\53b_convergencia.png')
...
plt.savefig(figDirectory + '\\53b_deflexao3D.png')
...
plt.savefig(figDirectory + '\\53b_Momentos.png')
...
plt.savefig(figDirectory + '\\53b_Cortante.png')
...
plt.savefig(figDirectory + '\\53b_forcas3D.png')
